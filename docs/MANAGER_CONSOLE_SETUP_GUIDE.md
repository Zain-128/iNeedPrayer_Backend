...
#### Product 2: 500 Coins
- **Type**: Consumable
- **Reference Name**: `500 Coins Package`
- **Product ID (SKU)**: `com.ineedprayer.coins500` *(Must match exactly)*
- **Price Tier**: Tier 4 ($3.99 USD)
- **Display Name**: `500 Coins`
- **Description**: `Purchase 500 coins for donations and super chats`

#### Product 3: 1000 Coins
- **Type**: Consumable
- **Reference Name**: `1000 Coins Package`
- **Product ID (SKU)**: `com.ineedprayer.coins1000` *(Must match exactly)*
- **Price Tier**: Tier 7 ($6.99 USD)
- **Display Name**: `1000 Coins`
- **Description**: `Purchase 1000 coins for donations and super chats`

#### Product 4: 2500 Coins
- **Type**: Consumable
- **Reference Name**: `2500 Coins Package`
- **Product ID (SKU)**: `com.ineedprayer.coins2500` *(Must match exactly)*
- **Price Tier**: Tier 15 ($14.99 USD)
- **Display Name**: `2500 Coins`
- **Description**: `Purchase 2500 coins for donations and super chats`

#### Product 5: 5000 Coins
- **Type**: Consumable
- **Reference Name**: `5000 Coins Package`
- **Product ID (SKU)**: `com.ineedprayer.coins5000` *(Must match exactly)*
- **Price Tier**: Tier 30 ($29.99 USD)
- **Display Name**: `5000 Coins`
- **Description**: `Purchase 5000 coins for donations and super chats`
...
|---|---|---|---|---|
| 100 Coins | `com.ineedprayer.coins100` | Consumable | $0.99 | Active |
| 500 Coins | `com.ineedprayer.coins500` | Consumable | $3.99 | Active |
| 1000 Coins | `com.ineedprayer.coins1000` | Consumable | $6.99 | Active |
| 2500 Coins | `com.ineedprayer.coins2500` | Consumable | $14.99 | Active |
| 5000 Coins | `com.ineedprayer.coins5000` | Consumable | $29.99 | Active |
