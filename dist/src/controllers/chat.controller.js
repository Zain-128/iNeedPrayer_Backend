...
import { broadcastNewMessage, broadcastChatUpdated, } from "../socket/chat.emit.js";
...
export const openConversation = async (req, res) => {
    try {
        ...
        const result = await chatService.getOrCreateConversation(req.userId, peerUserId);
...
export const createGroup = async (req, res) => {
    try {
        ...
        const result = await chatService.createGroupConversation(req.userId, {
            title,
            memberIds: memberIds.filter((x) => typeof x === "string"),
...
export const sendMessage = async (req, res) => {
    try {
        ...
        const persisted = await chatService.persistInboundChatMessage(id, req.userId, text, typeof messageType === "string" ? messageType : "text");
        const io = getIo();
        if (io) {
